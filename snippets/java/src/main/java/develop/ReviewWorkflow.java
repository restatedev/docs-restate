...
import static develop.ReviewWorkflowClient.askReview;
import static develop.ReviewWorkflowClient.processReview;
...
class ReviewWorkflowClient {
    public static void askReview(String documentId) {
    }

    public static String processReview(String docId, String review) {
        return "";
    }
}
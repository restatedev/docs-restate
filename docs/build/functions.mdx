---
title: Functions
description: Understanding how Restate functions work and how to write them
---

Functions are the core building blocks of Restate services. Under the hood, Restate marks each function you export as a handler—i.e. the code that actually executes when a request comes in.

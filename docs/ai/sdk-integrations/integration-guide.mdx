...
Restate has a flexible programming model which allows it to be integrated with many AI or Agent SDKs to add fault tolerance, automatic retries, and durable execution to your AI applications. While each SDK has its own API and patterns, the integration approach follows similar principles.

This guide covers the key patterns and requirements for integrating Restate with different types of SDKs.

<Info>
    If you are interested in the integration of a specific AI / Agent SDK, please reach out to us via [Discord](https://discord.com/invite/skW3AZ6uGd) or [Slack](https://join.slack.com/t/restatecommunity/shared_invite/zt-2v9gl005c-WBpr167o5XJZI1l7HWKImA).
</Info>
...
<img src="/img/ai/sdk-integrations/ai-sdks.png" alt="Diagram showing AI SDKs vs Agent SDKs architecture"/>

**1. AI SDKs** - These provide simplified interfaces for making LLM calls:
...
With AI SDKs, you maintain full control over when and how LLM calls are made. The integration is straightforward:
...
- Works with any AI SDK without modification
...
**Examples:**
Find complete integration examples in our patterns repository:
- [TypeScript patterns](https://github.com/restatedev/ai-examples/tree/main/typescript-patterns)
- [Python patterns](https://github.com/restatedev/ai-examples/tree/main/python-patterns)
...
For better resilience, integrate Restate at the tool level within the agent execution.
...
If you are stuck with an integration, please reach out to us via [Discord](https://discord.com/invite/skW3AZ6uGd) or [Slack](https://join.slack.com/t/restatecommunity/shared_invite/zt-2v9gl005c-WBpr167o5XJZI1l7HWKImA).
</Info>

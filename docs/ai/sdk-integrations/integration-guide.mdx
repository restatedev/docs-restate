...
**Examples:**
Find complete integration examples here:[TypeScript](https://github.com/restatedev/ai-examples/tree/ai-structure/typescript-restate-only/tour-of-agents) / [Python](https://github.com/restatedev/ai-examples/tree/ai-structure/python-restate-only/tour-of-agents)

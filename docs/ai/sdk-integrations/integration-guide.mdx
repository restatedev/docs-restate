...
**Examples:**
Find complete integration examples here: [TypeScript](https://github.com/restatedev/ai-examples/tree/main/typescript-restate-only/template) / [Python](https://github.com/restatedev/ai-examples/tree/main/python-restate-only/template)

...
```typescript chat-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/vercel-ai/tour-of-agents/src/chat-agent.ts#here"} 
...
```python chat_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/openai-agents/tour-of-agents/app/chat_agent.py#here"} 
...
```python chat_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/google-adk/tour-of-agents/app/chat_agent.py#here"} 
agent = Agent(
...
```typescript chat-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/typescript-restate-only/tour-of-agents/src/chat-agent.ts#here"} 
/**
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/ai-structure/typescript-restate-only/tour-of-agents/src/chat-agent.ts" />
...
```python chat_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/python-restate-only/tour-of-agents/app/chat_agent.py#here"} 
chat = restate.VirtualObject("Chat")
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/ai-structure/python-restate-only/tour-of-agents/app/chat_agent.py" />
...
To retrieve state, view the UI's state tab or add a shared handler that reads it. Have a look at the `getHistory` handler in the example above.
...
To retrieve state, view the UI's state tab or add a shared handler that reads it. Have a look at the `get_history` handler in the example above.

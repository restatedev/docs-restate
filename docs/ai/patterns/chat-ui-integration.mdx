...
```typescript app/agent/[topic]/api/route.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/vercel-ai/nextjs-example-app/app/agent/%5Btopic%5D/api/route.ts#here"} 

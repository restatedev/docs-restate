...
```python workflow_orchestrator.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/pydantic-ai/pydantic-ai/tour-of-agents/app/workflow_orchestrator.py#here"} 
planner = Agent(
    "openai:gpt-4o-mini",
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/pydantic-ai/pydantic-ai/tour-of-agents/app/workflow_orchestrator.py" />

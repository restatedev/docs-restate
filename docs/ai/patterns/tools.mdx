...
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/pydantic-ai/pydantic-ai/tour-of-agents/app/sub_workflow_agent.py#wf"} 
# Sub-workflow service for human approval
human_approval_workflow = restate.Service("HumanApprovalWorkflow")
...
async def review(ctx: restate.Context, claim: InsuranceClaim) -> str:
    ...
    return await approval_promise
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/pydantic-ai/pydantic-ai/tour-of-agents/app/sub_workflow_agent.py" />
...
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/pydantic-ai/pydantic-ai/tour-of-agents/app/sub_workflow_agent.py#here"} 
@agent.tool

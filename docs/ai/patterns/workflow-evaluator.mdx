...
```python workflow_evaluator_optimizer.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/pydantic-ai/pydantic-ai/tour-of-agents/app/workflow_evaluator_optimizer.py#here"} 
generator = Agent(
    "openai:gpt-4o-mini",
...
async def generate(_ctx: restate.Context, req: CodeRequest) -> dict:
    ...
    return {"code": "Max iterations reached", "iterations": max_iterations}
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/pydantic-ai/pydantic-ai/tour-of-agents/app/workflow_evaluator_optimizer.py" />

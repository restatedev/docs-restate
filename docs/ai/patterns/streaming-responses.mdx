...
<Card title="nextjs-example-app" icon="github" horizontal href="https://github.com/restatedev/ai-examples/tree/ai-structure/vercel-ai/nextjs-example-app">
...
```
<GitHubLink url={"https://github.com/restatedev/ai-examples/blob/ai-structure/vercel-ai/nextjs-example-app/restate/endpoint.ts"}/>
...
```
<GitHubLink url={"https://github.com/restatedev/ai-examples/blob/ai-structure/vercel-ai/nextjs-example-app/restate/services/agent.ts"}/>
...
```
<GitHubLink url={"https://github.com/restatedev/ai-examples/blob/ai-structure/vercel-ai/nextjs-example-app/app/pubsub/%5Btopic%5D/route.ts"}/>
...
```typescript app/agent/[topic]/page.tsx {"CODE_LOAD::ts/src/ai/guides/streaming-responses/frontend.tsx#here"} 
let offset = 0;
...
```
<GitHubLink url={"https://github.com/restatedev/ai-examples/blob/ai-structure/vercel-ai/nextjs-example-app/app/agent/%5Btopic%5D/page.tsx"}/>

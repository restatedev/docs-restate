...
```python multi_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/pydantic-ai/pydantic-ai/tour-of-agents/app/multi_agent.py#here"} 
medical_agent = Agent(
    "openai:gpt-4o-mini",
...
async def run(_ctx: restate.ObjectContext, claim: InsuranceClaim) -> str:
    ...
    return result.output
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/pydantic-ai/pydantic-ai/tour-of-agents/app/multi_agent.py" />

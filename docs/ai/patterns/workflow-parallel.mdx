...
```python workflow_parallel.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/pydantic-ai/tour-of-agents/app/workflow_parallel.py#here"} 
@agent_service.handler()
...
<Frame>
<img src="/img/tour/agents/pydantic/parallel-agents.png" alt="Parallel agent execution trace" />
</Frame>
</Accordion>
...
```python workflow_parallel.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/langchain-python/tour-of-agents/app/workflow_parallel.py#here"} 

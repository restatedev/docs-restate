...
```python parallel_tools.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/python-patterns/app/parallel_tools.py?collapse_prequel"}
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/main/python-patterns/app/parallel_tools.py" />

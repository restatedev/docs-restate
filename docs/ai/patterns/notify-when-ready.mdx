...
```python agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/openai-agents/examples/notify_when_ready/agent.py#here"} 
import restate
...
# response is sent via email when it's ready.
...
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/ai-structure/openai-agents/examples/notify_when_ready/agent.py" />

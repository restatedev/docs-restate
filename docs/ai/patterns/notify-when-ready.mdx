...
With Restate's workflow promises, you can coordinate between agent execution and notification handlers, no extra infrastructure needed.
...
- **Workflow promises**: Create workflow-scoped results that survive failures and restarts

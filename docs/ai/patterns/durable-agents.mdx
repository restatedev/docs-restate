...
```python agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/pydantic-ai/pydantic-ai/template/agent.py"} 
import restate
from pydantic import BaseModel
...
<GitHubLink url={"https://github.com/restatedev/ai-examples/blob/pydantic-ai/pydantic-ai/template/agent.py"}/>

...
```python agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/google-adk/template/agent.py#here"}
import restate
...
```python agent {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/python-restate-only/template/agent.py#here"}
...
<GitHubLink url={"https://github.com/restatedev/ai-examples/blob/ai-structure/python-restate-only/template/agent.py"}/>

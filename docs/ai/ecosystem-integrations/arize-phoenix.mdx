...
Initialize Arize Phoenix and wrap the tracer with `RestateTracerProvider` to correlate AI spans with Restate's execution journal:

```python __main__.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/langfuse-other-sdks/openai-agents/examples/arize_phoenix/__main__.py#here"} 
...
<GitHubLink url={"https://github.com/restatedev/ai-examples/tree/langfuse-other-sdks/openai-agents/examples/arize_phoenix"}/>

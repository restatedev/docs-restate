...
<CodeGroup>
    ```java Java {"CODE_LOAD::java/src/main/java/develop/JournalingResults.java#deterministic_time"} 
Instant now = Restate.instantNow();
```
```kotlin Kotlin {"CODE_LOAD::kotlin/src/main/kotlin/develop/DeterministicTime.kt#deterministic_time"} 

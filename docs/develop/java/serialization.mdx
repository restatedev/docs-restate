...
For Kotlin, import the following in your code:
```kotlin {"CODE_LOAD::kotlin/src/main/kotlin/develop/SerializationExample.kt#import"} 
import dev.restate.serde.kotlinx.*
```

Then you can create type tags as follows:
```kotlin {"CODE_LOAD::kotlin/src/main/kotlin/develop/SerializationExample.kt#typetag"} 
var myType = typeTag<String>()
```
For example, you need this for the [typed SDK clients](/services/invocation/clients/java-sdk).

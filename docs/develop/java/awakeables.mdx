...
Your workflow can [suspend](/basics/key-concepts#suspensions-on-faas) until the promise is resolved or rejected.
...
<CodeGroup>
```java Java {"CODE_LOAD::java/src/main/java/develop/ReviewWorkflow.java#here"} 
@Workflow
...
```
```kotlin Kotlin {"CODE_LOAD::kotlin/src/main/kotlin/develop/ReviewWorkflow.kt#here"} 
@Workflow

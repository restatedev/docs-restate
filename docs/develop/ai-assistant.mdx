...
- [Go SDK AGENTS.md](/agentsmd/golang/AGENTS.md)
...
<CodeGroup>
    ...
    ```
    ```shell Go
    wget https://docs.restate.dev/agentsmd/golang/AGENTS.md
    ```
</CodeGroup>
...
<CodeGroup>
    ...
    ```
    ```shell Go
    wget -O CLAUDE.md https://docs.restate.dev/agentsmd/golang/AGENTS.md
    ```
</CodeGroup>

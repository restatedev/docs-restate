...
<CodeGroup>
    ```shell Typescript
    wget https://docs.restate.dev/develop/ts/AGENTS.md
    ```
    ```shell Java
    wget https://docs.restate.dev/develop/java/AGENTS.md
    ```
    ```shell Python
    wget https://docs.restate.dev/develop/python/AGENTS.md
    ```
    ```shell Go
    wget https://docs.restate.dev/develop/go/AGENTS.md
    ```
</CodeGroup>
...
<CodeGroup>
    ...
    ```
    ```shell Java
    wget -O CLAUDE.md https://docs.restate.dev/develop/java/AGENTS.md
    ```
    ```shell Python
    wget -O CLAUDE.md https://docs.restate.dev/develop/python/AGENTS.md
    ```
    ```shell Go
    wget -O CLAUDE.md https://docs.restate.dev/develop/go/AGENTS.md
    ```
</CodeGroup>

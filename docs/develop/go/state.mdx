...
```typescript {"CODE_LOAD::go/develop/state.go#statekeys"} 
...
```typescript {"CODE_LOAD::go/develop/state.go#get"} 
myString := "my-default"
...
```typescript {"CODE_LOAD::go/develop/state.go#set"} 
...
```typescript {"CODE_LOAD::go/develop/state.go#clear"} 
...
```typescript {"CODE_LOAD::go/develop/state.go#clear_all"} 

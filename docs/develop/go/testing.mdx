...
```go {"CODE_LOAD::go/develop/testing.go#mock_context"}
...
```go {"CODE_LOAD::go/develop/testing.go#state_get"}
// Mock getting state
mockCtx.EXPECT().GetAndReturn("status", TicketAvailable)
```

```go {"CODE_LOAD::go/develop/testing.go#state_set"}
// Mock setting state
mockCtx.EXPECT().Set("status", TicketReserved)
```

```go {"CODE_LOAD::go/develop/testing.go#state_clear"}
// Mock clearing state
mockCtx.EXPECT().Clear("status")
```

```go {"CODE_LOAD::go/develop/testing.go#state_clear_all"}
...
```go {"CODE_LOAD::go/develop/testing.go#side_effect"}
...
```go {"CODE_LOAD::go/develop/testing.go#random"}
...
```go {"CODE_LOAD::go/develop/testing.go#logging"}
...
```go {"CODE_LOAD::go/develop/testing.go#context_key"}
...
```go {"CODE_LOAD::go/develop/testing.go#workflow_test"}
...
```go {"CODE_LOAD::go/develop/testing.go#complete_example"}

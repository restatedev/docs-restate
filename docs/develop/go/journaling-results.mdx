...
```typescript {"CODE_LOAD::go/develop/journalingresults.go#side_effect_retry"} 
...
```typescript {"CODE_LOAD::go/develop/journalingresults.go#uuid"} 
...
```typescript {"CODE_LOAD::go/develop/journalingresults.go#random_nb"} 

...
`create_test_harness` starts the application and Restate Server, registers the application, and stops both when the context exits. The returned environment provides:

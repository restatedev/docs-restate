...
When calling services from outside a Restate handler using the ingress client (`@restatedev/restate-sdk-clients`), you can set a default serde for an entire connection or override it per operation.

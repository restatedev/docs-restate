...
When using the [`@restatedev/restate-sdk-clients`](/services/invocation/clients/typescript-sdk) package to invoke handlers from outside Restate, you can set a default serde at the connection level. This applies to all operations on the client unless overridden per-call:
...
See the [TypeScript SDK Clients docs](/services/invocation/clients/typescript-sdk#custom-serialization) for more details.

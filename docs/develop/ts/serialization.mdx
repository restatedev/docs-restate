...
When using the [ingress client](/services/invocation/clients/typescript-sdk) (`@restatedev/restate-sdk-clients`) from outside Restate, you can set a default serde on the connection itself instead of specifying it per-call:

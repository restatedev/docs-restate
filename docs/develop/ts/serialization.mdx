...
Per-call options take precedence over the connection-level default. See the [SDK clients docs](/services/invocation/clients/typescript-sdk#custom-serialization) for per-call override examples.

...
Check out the [workflow documentation](/develop/ts/overview#workflows) to learn how to invoke workflows.
...
Check out the [workflow documentation](/develop/ts/overview#workflows) to learn how to attach to workflow executions.

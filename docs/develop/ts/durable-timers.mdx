...
- If you sleep in an [exclusive handler](/basics/functions#handler-behavior) in a Virtual Object, all other calls to this object will be queued.
- You need to keep the deployment version until the invocation completes (see [versioning](/operate/registration)).

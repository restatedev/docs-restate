...
<CardGroup cols={2}>
  ...
  <Card title="Ruby" icon="/img/languages/ruby-primary.svg">
    [GitHub](https://github.com/restatedev/sdk-ruby)
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="restatectl" icon="gears">
    ...
    [Docs](/installation#advanced-installing-restatectl) • [GitHub](https://github.com/restatedev/restate/tree/main/tools/restatectl) • [npm](https://www.npmjs.com/package/@restatedev/restatectl)

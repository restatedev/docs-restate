...
<Columns cols={3}>
    <Card title="TypeScript" href="/develop/ts/services" icon="/img/languages/typescript.svg" horizontal={true}/>
    <Card title="Java" href="/develop/java/services" icon="/img/languages/java.svg" horizontal={true}/>
    <Card title="Kotlin" href="/develop/java/services" icon="/img/languages/kotlin.svg" horizontal={true}/>
    <Card title="Python" href="/develop/python/services" icon="/img/languages/python.svg" horizontal={true}/>
    <Card title="Go" href="/develop/go/services" icon="/img/languages/go.svg" horizontal={true}/>

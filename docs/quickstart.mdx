...
```
            ...
            <Tab title={"Next.js"} icon={"/img/quickstart/nextjs.svg"}>
                ...
                <Steps>
                    ...
                    <Step title={"Get the Greeter service template"}>
                        ```shell
                        restate example typescript-hello-world-nextjs &&
                        cd typescript-hello-world-nextjs &&
                        npm install
                        ```
                    ...
                    <Step title={"Register the service"}>
                        ...
                        If you run Restate with Docker, register `http://host.docker.internal:3000/restate/v1` instead of `http://localhost:3000/restate/v1`.

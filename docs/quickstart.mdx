            ...
            <Tab title={"Next.js"} icon={"/img/quickstart/nextjs.svg"}>
                ...
                <Steps>
                    ...
                    <Step title={"Get the Greeter service template"}>
                        ...
                        npm install
                        ```
                        [View on GitHub](https://github.com/restatedev/examples/blob/main/typescript/templates/nextjs/restate/greeter.ts)
                    ...
                    <Step title="Congratulations, you just ran Durable Execution!">
                        <DurableExecutionPre/>
```ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/main/typescript/templates/nextjs/restate/greeter.ts?collapse_prequel"} 
export const greeter = restate.service({
  name: "Greeter",
  handlers: {
    greet: restate.createServiceHandler(

...
Restate provides durable building blocks that make complex distributed systems simple. Write normal code while Restate handles failures, coordination, and state consistency automatically.

## What is Restate?

Restate is a runtime that makes your functions durable, reliable, and stateful. It turns regular functions into fault-tolerant building blocks that can survive failures, restarts, and infrastructure issues while maintaining exactly-once execution guarantees.
...
**Built-in state**: Store and retrieve data directly in your functions without external databases, with strong consistency guarantees.
...
**[Virtual Objects](/build/services/virtual-object)**: Stateful functions with per-key storage and single-writer semantics. Ideal for user accounts, shopping carts, and entity management.
...
2. **[Concepts](/concepts)**: Understand core Restate concepts and terminology  

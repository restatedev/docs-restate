...
<Columns cols={3}>
    ...
    <Card title="Tour of Restate" icon={"graduation-cap"}>
        Understand how Restate simplifies implementing:
        <ul>
            <li>- [AI agents](/tour/ai-agents)</li>
            <li>- [Workflows](/tour/workflows)</li>
            <li>- [Microservice orchestration](/tour/microservice-orchestration)</li>
        </ul>
    </Card>
</Columns>
...
<CardGroup cols={3}>
    ...
    >
        ...
        <div className="flex gap-5">
            [<Icon icon={"/img/languages/typescript.svg"}/>](/develop/ts/overview)
            [<Icon icon={"/img/languages/java.svg"}/>](/develop/java/overview)
            [<Icon icon={"/img/languages/kotlin.svg"}/>](/develop/java/overview)
            [<Icon icon={"/img/languages/python.svg"}/>](/develop/python/overview)
            [<Icon icon={"/img/languages/go.svg"}/>](/develop/go/overview)
            [<Icon icon={"/img/languages/rust.svg"}/>](https://docs.rs/restate-sdk/latest/restate_sdk/)
        </div>
    </Card>
    ...
    <Card
        ...
        icon="box"
        href="/deploy/services/kubernetes"
    >
        Deploy your services to one of the supported platforms.
    </Card>

    <Card
        title="Deploy Restate Server"
        icon="cloud"

...
<Info>
[Restate Cloud](/cloud/getting-started) provides built-in authentication, access control, and header filtering. Restate BYOC has a separate [security model](/byoc/security). The guidance on this page applies to self hosted deployments where you manage these layers yourself.
</Info>

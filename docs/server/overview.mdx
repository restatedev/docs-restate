...
1. A **runtime environment** where you can run the Restate Docker container or binary.
...
Restate is a stateful system that persists data in its embedded state store.

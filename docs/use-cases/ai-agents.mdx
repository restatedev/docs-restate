...
<CardGroup cols={3}>
    ...
    <Card title="Multi-agent Orchestration" icon="users-gear">
    ...
    <Card title="Interruptible Agents" icon="hand">
...
<CardGroup cols={3}>
  ...
  <Card title="Hands-on Tutorial" icon="pen" href="/tour/vercel-ai-agents">

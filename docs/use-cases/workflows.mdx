...
<AccordionGroup>
    <Accordion title={"Flexible Activity Execution: inline or separate services"}>
    ...
    <Accordion title={"Durable State and Queries"}>
    ...
    <Accordion title={"Durable Timers and Scheduling"}>

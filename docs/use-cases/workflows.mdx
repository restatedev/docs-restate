...
```typescript {"CODE_LOAD::ts/src/usecases/workflows/order-processing.ts#here"} 
...
```typescript {"CODE_LOAD::ts/src/usecases/workflows/signup.ts#here"} 
...
```typescript {"CODE_LOAD::ts/src/usecases/workflows/workflow-actions.ts#state"} 
// Store intermediate results
ctx.set("payment-status", "completed");
ctx.set("order-details", order);
```

```typescript {"CODE_LOAD::ts/src/usecases/workflows/workflow-actions.ts#state_get"} 
...
```typescript {"CODE_LOAD::ts/src/usecases/workflows/workflow-actions.ts#approval"} 
// Wait for external approval
const approval = await ctx.promise<boolean>("manager-approval");
```
```typescript {"CODE_LOAD::ts/src/usecases/workflows/workflow-actions.ts#approve"} 
...
```typescript {"CODE_LOAD::ts/src/usecases/workflows/workflow-actions.ts#timers"} 

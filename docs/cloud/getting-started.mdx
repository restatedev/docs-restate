...
An environment is an instance of the Restate server that is unique to you, and managed by Restate.
...
After connecting your CLI to your environment, you can use the CLI tunnel feature to expose your local service to the cloud.
...
Then, copy the tunnel url from the output and register it to your environment using CLI or UI
```bash

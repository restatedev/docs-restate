...
<img src="/img/tour/tour-overview.svg"/>
...
<Steps>
<Step title="Set up the services">
    <Tabs>
        <Tab title="TypeScript">
...
<Note>Implement it yourself or follow along by looking at the code under part1</Note>
...
<Note title={<>Why does the path contain <code>Mary</code>?</>}>
...
[TODO ANIMATION DURABLE EXECUTION]
...
<Note title={"Error handling in Restate"}>
...
<AccordionGroup>
<Accordion title={"List the services"}>
...
<Accordion title={"List the ongoing invocations"}>
...
<Accordion title={"Describe invocations"}>
...
<Accordion title={"Cancel invocations"}>
...
<Note>Implement it yourself or follow along by looking at the code under part2</Note>
...
<Tabs>
    ...
    <Tab title="Rust">
        ...
        <Accordion title={"Restate Server logs"}>
...
<Tip title={"No workflow orchestrator or cron jobs needed!"}>
...
<Note>Implement it yourself or follow along by looking at the code under part3</Note>
...
<Tip title={"Virtual Objects simplify many use cases"}>
...
<Warning title={"Long-running operations in Virtual Objects"}>
...
<Tip title="No need for session databases!">
...
<Tabs>
    <Tab title="TypeScript">
        <Step title="TicketObject/reserve">
        ...
        <Step title="TicketObject/unreserve">
        ...
        <Step title="TicketObject/markAsSold">
...
<Note>Implement it yourself or follow along by looking at the code under part4</Note>
...
<Steps>
<Step title="Generate an idempotency token">
    <Tabs>
        <Tab title="TypeScript">
...
<Tabs>
    <Tab title="TypeScript">
        <Step title="Implement the email notifications">
        ...
        <Step title="Mark tickets as sold">
...
<Tip title="End-to-end idempotency">

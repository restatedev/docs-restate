...
```python durable_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/durable_agent.py?collapse_imports"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/durable_agent.py" />
...
The endpoint that serves the agents of this tour over HTTP is defined in [`__main__.py`](https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/__main__.py).
...
```python utils/utils.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/utils/utils.py#weather"} 
...
```python human_approval_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/human_approval_agent.py#here"} 
@function_tool(failure_error_function=raise_restate_errors)
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/human_approval_agent.py" />
...
```python human_approval_agent_with_timeout.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/human_approval_agent_with_timeout.py#here"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/human_approval_agent_with_timeout.py" />
...
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/sub_workflow_agent.py#wf"} 
...
async def request_approval(
    ...
    return await approval_promise
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/sub_workflow_agent.py" />

This can now be called from the main agent via a service client:
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/sub_workflow_agent.py#here"} 
@function_tool(failure_error_function=raise_restate_errors)
async def human_approval(
    wrapper: RunContextWrapper[restate.Context], claim: InsuranceClaim
) -> str:
...
```python chat.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/chat.py?collapse_imports"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/chat.py" />
...
```python multi_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/multi_agent.py?collapse_imports"} 
...
async def run(restate_context: restate.ObjectContext, claim: InsuranceClaim) -> str:
    ...
    return result.final_output
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/multi_agent.py" />
...
```python multi_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/multi_agent_remote.py#here"} 
...
```python parallel_tools_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/parallel_tools_agent.py#here"} 
@function_tool(failure_error_function=raise_restate_errors)
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/parallel_tools_agent.py" />
...
```python parallel_agents.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/parallel_agents.py#here"} 
@agent_service.handler()
async def run(restate_context: restate.Context, claim: InsuranceClaim) -> str:
    ...
    return result.final_output
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/parallel_agents.py" />
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/errorhandling_fail_on_terminal_tool_agent.py" />
...
Terminal errors thrown from Restate Context actions are not retried by Restate, and get processed by the OpenAI Agent SDK.
Also here, the OpenAI Agent SDK will convert the error into a message to the LLM, and the agent will decide how to proceed.
...
You can do this by setting your tool's `failure_error_function` to `raise_terminal_error` from the Restate middleware.
Now, any terminal error in the tool execution will be re-raised as a `TerminalError`, instead of swallowed by the agent.

```python error_handling.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/error_handling.py#here"} 
@function_tool(failure_error_function=raise_restate_errors)
async def get_weather(
    wrapper: RunContextWrapper[restate.Context], req: WeatherRequest
) -> WeatherResponse:
...
```python error_handling.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/error_handling.py#handle"} 
try:
    result = await Runner.run(
        weather_agent,
        input=prompt.message,
...
This allows you to:
- Parallelize tool calls with `restate.select`
...
```python advanced/manual_loop_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/advanced/manual_loop_agent.py?collapse_imports"} 
client = OpenAI()
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/advanced/manual_loop_agent.py" />
...
```python advanced/rollback_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/tour_openai/openai-agents/tour-of-agents/app/advanced/rollback_agent.py?collapse_imports"} 
...
async def book(restate_context: restate.Context, prompt: BookingPrompt) -> str:
    ...
    return result.final_output
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/tour_openai/openai-agents/tour-of-agents/app/advanced/rollback_agent.py" />

Try it out by sending the following request:
```bash
curl localhost:8080/BookingWithRollbackAgent/book \
--json '{"message": "I need to book a business trip to San Francisco from March 15-17. Flying from JFK, need a hotel downtown for 1 guest."}'
```
...
```bash
curl localhost:8080/BookingWithRollbackAgent/book \
--json '{"message": "Planning a family vacation to Miami for 4 people from May 20-25. We need flights from Boston Logan BOS, a beachfront hotel for 4 guests, and an SUV rental with pick-up at BOS airport."}'
```

...
- Integrate Restate and the OpenAI Agent SDK
...
```python durable_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/durable_agent.py?collapse_prequel"}

```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/durableexecution/agent.ts" />
...
```ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/utils.ts#weather"} 
...
```python humanintheloop/agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/humanintheloop/agent.ts#here"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/humanintheloop/agent.ts" />
...
```python humanintheloop/agent-with-timeout.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/humanintheloop/agent-with-timeout.ts#here"} 
try {
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/humanintheloop/agent-with-timeout.ts" />
...
```python chat/agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/chat/agent.ts?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/chat/agent.ts" />
...
```python orchestration/sub-workflow-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/orchestration/sub-workflow-agent.ts#wf"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/orchestration/sub-workflow-agent.ts" />

This can now be called from the main agent via a service client:
```python orchestration/sub-workflow-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/orchestration/sub-workflow-agent.ts#here"} 
humanApproval: tool({
  description: "Ask for human approval for high-value claims.",
  inputSchema: InsuranceClaimSchema,
...
```python orchestration/multi-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/orchestration/multi-agent.ts#here"} 
const { text } = await generateText({
  model,
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/orchestration/multi-agent.ts" />
...
```python parallelwork/parallel-tools-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/parallelwork/parallel-tools-agent.ts#here"} 
const { text } = await generateText({
  model,
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/parallelwork/parallel-tools-agent.ts" />
...
```python parallelwork/parallel-agents.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/parallelwork/parallel-agents.ts?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/parallelwork/parallel-agents.ts" />
...
```python {"CODE_LOAD::ts/src/tour/agents/terminal_error.ts#terminal_error"} 
...
```python errorhandling/fail-on-terminal-tool-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/errorhandling/fail-on-terminal-tool-agent.ts#max_attempts_example"} 
const model = wrapLanguageModel({
  model: openai("gpt-4o"),
  middleware: durableCalls(ctx, { maxRetryAttempts: 3 }),
});
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/errorhandling/fail-on-terminal-tool-agent.ts" />
...
```python errorhandling/fail-on-terminal-tool-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/errorhandling/fail-on-terminal-tool-agent.ts#option2"} 
const { text } = await generateText({
  model,
  tools: {
    getWeather: tool({
...
```python errorhandling/stop-on-terminal-tool-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/errorhandling/stop-on-terminal-tool-agent.ts#option3"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/errorhandling/stop-on-terminal-tool-agent.ts" />
</Accordion>
</AccordionGroup>
...
```python advanced/manual-loop-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/advanced/manual-loop-agent.ts?collapse_prequel"} 
export default restate.service({
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/advanced/manual-loop-agent.ts" />
...
```python advanced/rollback-agent.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/main/openai-agents/tour-of-agents/src/advanced/rollback-agent.ts#here"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/main/openai-agents/tour-of-agents/src/advanced/rollback-agent.ts" />

...
<Note title="Implement it yourself or follow along by looking at the code under part1"/>
...
<Note title="Implement it yourself or follow along by looking at the code under part2"/>
...
<Note title="Implement it yourself or follow along by looking at the code under part3"/>
...
<Note title="Implement it yourself or follow along by looking at the code under part4"/>
...
<Step title="Relaunch Restate with tracing enabled">
...
<Step title="Go to the Jaeger UI">
    http://localhost:16686
</Step>
<Step title="Inspect the traces">

...
```
    <GitHubLink url="tsGitUrl/getstarted/service.ts" />
</GlobalTab>
<GlobalTab title="Java">
...
```
    ...
    <GitHubLink url="javaGitUrl/getstarted/SubscriptionService.java" />
</GlobalTab>
<GlobalTab title="Go">
...
```
    <GitHubLink url="goGitUrl/getstarted/service.go" />
</GlobalTab>
<GlobalTab title="Python">
...
```
    <GitHubLink url="pyGitUrl/getstarted/service.py" />
</GlobalTab>
</GlobalTabs>
...
public class SubscriptionClient {
    public static void createSubscription(String s, String subscription, String paymentRef) {
        // Simulate creating a subscription
        System.out.println("Creating subscription for user: " + s + ", subscription: " + subscription + ", paymentRef: " + paymentRef);
    }
...
```
        ...
        <GlobalTab title="Python">
            ...
            ```python {CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/utils.py#subscription}
            ```
            <GitHubLink url="pyGitUrl/getstarted/service.py" />
        </GlobalTab>
    </GlobalTabs>
...
```
        <GitHubLink url="tsGitUrl/sagas/service.ts" />
    </GlobalTab>
    <GlobalTab title="Java">
...
```
        ...
        <GitHubLink url="javaGitUrl/getstarted/sagas/SubscriptionSaga.java" />
    </GlobalTab>
    <GlobalTab title="Go">
...
```
        <GitHubLink url="goGitUrl/sagas/service.go" />
    </GlobalTab>
    <GlobalTab title="Python">
...
```
        <GitHubLink url="pyGitUrl/sagas/service.py" />
    </GlobalTab>
</GlobalTabs>
...
```
        <GitHubLink url="tsGitUrl/objects/service.ts" />
    </GlobalTab>
    <GlobalTab title="Java">
...
```
        ...
        <GitHubLink url="javaGitUrl/objects/UserSubscriptions.java" />
    </GlobalTab>
    <GlobalTab title="Go">
...
```
        <GitHubLink url="goGitUrl/objects/service.go" />
    </GlobalTab>
    <GlobalTab title="Python">
...
```
        <GitHubLink url="pyGitUrl/objects/service.py" />
    </GlobalTab>
</GlobalTabs>
...
<Accordion title={"Try it out"}>
    ...
    To call a Virtual Object, you specify the object key in the URL (here `user-123`):
...
```
        <GitHubLink url="tsGitUrl/communication/service.ts" />
    </GlobalTab>
    <GlobalTab title="Java">
...
```
        ...
        <GitHubLink url="javaGitUrl/communication/ConcertTicketingService.java" />
    </GlobalTab>
    <GlobalTab title="Go">
...
```
        <GitHubLink url="goGitUrl/communication/service.go" />
    </GlobalTab>
    <GlobalTab title="Python">
...
```
        <GitHubLink url="pyGitUrl/communication/service.py" />
    </GlobalTab>
</GlobalTabs>
...
```
        <GitHubLink url="tsGitUrl/events/service.ts" />
    </GlobalTab>
    <GlobalTab title="Java">
...
```
        ...
        <GitHubLink url="javaGitUrl/events/Payments.java" />
    </GlobalTab>
    <GlobalTab title="Go">
...
```
        <GitHubLink url="goGitUrl/events/service.go" />
    </GlobalTab>
    <GlobalTab title="Python">
...
```
        <GitHubLink url="pyGitUrl/events/service.py" />
    </GlobalTab>
</GlobalTabs>
...
```
        <GitHubLink url="tsGitUrl/timers/service.ts" />
    </GlobalTab>
    <GlobalTab title="Java">

        ```java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/timers/PaymentsWithTimeoutService.java?collapse_prequel"} 
@Service
...
```
        ...
        <GitHubLink url="javaGitUrl/timers/PaymentsWithTimeoutService.java" />
    </GlobalTab>
    <GlobalTab title="Go">
...
```
        <GitHubLink url="goGitUrl/timers/service.go" />
    </GlobalTab>
    <GlobalTab title="Python">
...
```
        <GitHubLink url="pyGitUrl/timers/service.py" />
    </GlobalTab>
</GlobalTabs>
...
```
        <GitHubLink url="tsGitUrl/concurrenttasks/service.ts" />
    </GlobalTab>
    <GlobalTab title="Java">
...
```
        ...
        <GitHubLink url="javaGitUrl/concurrenttasks/ParallelSubscriptionService.java" />
    </GlobalTab>
    <GlobalTab title="Go">
...
```
        <GitHubLink url="goGitUrl/concurrenttasks/service.go" />
    </GlobalTab>
    <GlobalTab title="Python">
...
```
        <GitHubLink url="pyGitUrl/concurrenttasks/service.py" />
    </GlobalTab>
</GlobalTabs>

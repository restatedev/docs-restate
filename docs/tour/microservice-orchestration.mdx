...
<Accordion title={"Try it out"}>
    ...
    <Frame>
        <img src="/img/tour/microservices/sagas.png" alt="Workflow Sagas"/>
    </Frame>
</Accordion>
...
<Frame>
<img src="/img/tour/microservices/state.png" alt="Workflow Sagas"/>
</Frame>

<Accordion title={"Try it out"}>

    Add a few subscriptions for a user:
    ```bash

...
```ts src/getstarted/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/getstarted/service.ts?collapse_prequel"} 
...
```java my/example/getstarted/SubscriptionService.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/getstarted/SubscriptionService.java?collapse_prequel"} 
@Service
...
```go getstarted.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/getstarted.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/getstarted.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/getstarted/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/getstarted/service.py?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples" />
...
<img src="/img/tour/microservices/durable-execution-animation-microservices.gif" alt="Context in Restate" />
...
```go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/utils.go#subscription"} 
...
```java {"CODE_LOAD::java/src/main/java/tour/microservices/ErrorHandler.java#here"} 
...
```ts src/sagas/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/sagas/service.ts?collapse_prequel"} 
...
```java my/example/sagas/SubscriptionSaga.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/sagas/SubscriptionSaga.java?collapse_prequel"} 
@Service
...
```go sagas.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/sagas.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/sagas.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/sagas/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/sagas/service.py?collapse_prequel"} 
...
```ts src/objects/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/objects/service.ts?collapse_prequel"} 
...
```java my/example/objects/UserSubscriptions.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/objects/UserSubscriptions.java?collapse_prequel"} 
@VirtualObject
...
```go objects.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/objects.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/objects.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/objects/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/objects/service.py?collapse_prequel"} 
...
- K/V state is stored permanently. It has no automatic expiry. Clear it via `ctx.clear()` (or `restate.Clear()` for Go).
...
```ts src/communication/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/communication/service.ts?collapse_prequel"} 
...
```java my/example/communication/ConcertTicketingService.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/communication/ConcertTicketingService.java?collapse_prequel"} 
@Service
...
```go communication.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/communication.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/communication.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/communication/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/communication/service.py?collapse_prequel"} 
...
```ts src/events/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/events/service.ts?collapse_prequel"} 
...
```java my/example/events/Payments.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/events/Payments.java?collapse_prequel"} 
@Service
...
```go events.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/events.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/events.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/events/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/events/service.py?collapse_prequel"} 
...
```ts src/timers/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/timers/service.ts?collapse_prequel"} 
...
```java my/example/timers/PaymentsWithTimeout.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/timers/PaymentsWithTimeout.java?collapse_prequel"} 
@Service
...
```go timers.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/timers.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/timers.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/timers/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/timers/service.py?collapse_prequel"} 
...
```ts src/concurrenttasks/service.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-orchestration-typescript/src/concurrenttasks/service.ts?collapse_prequel"} 
...
```java my/example/concurrenttasks/ParallelSubscriptionService.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-orchestration-java/src/main/java/my/example/concurrenttasks/ParallelSubscriptionService.java?collapse_prequel"} 
@Service
...
```go concurrenttasks.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-orchestration-go/examples/concurrenttasks.go?collapse_prequel"} 
...
```
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-orchestration-go/examples/concurrenttasks.go" />
</GlobalTab>
<GlobalTab title="Python">

```python app/concurrenttasks/service.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-orchestration-python/app/concurrenttasks/service.py?collapse_prequel"} 

...
<GlobalTabs>
    ...
    <GlobalTab title="Go">
        ...
        ```
        <GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples" />
...
<Accordion title={"Try it out"} icon={"laptop"}>
...
<GlobalTabs>
    <GlobalTab title="TypeScript">
        ```bash
        curl localhost:8080/SignupWithSignalsWorkflow/johndoe/run \
        --json '{"name": "John Doe", "email": "john@mail.com"}'
        ```
    </GlobalTab>
    <GlobalTab title="Java">
...
<GlobalTabs>
    <GlobalTab title="TypeScript">
        ```bash
        curl localhost:8080/SignupWithEventsWorkflow/johndoe/run \
        --json '{"name": "John Doe", "email": "john@mail.com"}'
        ```
...
<GlobalTabs>
    <GlobalTab title="TypeScript">
        ```bash
        curl localhost:8080/SignupWithTimersWorkflow/johndoe/run \
        --json '{"name": "John Doe", "email": "john@mail.com"}'
        ```
    </GlobalTab>
    <GlobalTab title="Java">
...
Learn more from the serving section ([TS](/develop/ts/serving) / [Java / Kotlin](/develop/java/serving)  / [Python](/develop/python/serving)/ [Go](/develop/go/serving)).

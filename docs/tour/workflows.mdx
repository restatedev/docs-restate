...
```typescript signup-workflow.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-workflow.ts?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-workflow.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWorkflow.java?collapse_prequel"} 
@Workflow
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go getstarted.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/getstarted.go?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/getstarted.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_workflow.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_workflow.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_workflow.py" />
...
<GlobalTabs>
    <GlobalTab title="TypeScript">
        ...
        npm install
        ```
        <GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript" />
    ...
    <GlobalTab title="Java">
        ...
        ```
        <GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java" />
    ...
    <GlobalTab title="Go">
        ...
        ```
        <GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go" />
    ...
    <GlobalTab title="Python">
        ...
        ```
        <GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python" />
...
```ts client.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/client.ts#submit"} 
...
You can invoke a workflow programmatically with the Restate SDK:
```java WorkflowSubmitter.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/WorkflowSubmitter.java#submit"} 
...
You can invoke a workflow programmatically with the Restate SDK:
```go client.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/client/client.go#submit"} 
...
```python client.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/client.py#submit"} 
key = "user-123"
...
```ts utils.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/utils.ts#here"} 
...
```java Utils.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/utils/Utils.java#here"} 
...
```go utils.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/utils.go#here"} 
...
```python utils.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/utils.py#here"} 
...
```ts signup-with-activities.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-activities.ts#activities"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-activities.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithActivitiesWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithActivitiesWorkflow.java#activities"} 
// Move user DB interaction to dedicated service
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithActivitiesWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go activities.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/activities.go#activities"} 
// Move user DB interaction to dedicated service
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/activities.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_activities.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_activities.py#activities"} 
# Move user DB interaction to dedicated service
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_activities.py" />
...
```ts signup-with-queries.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-queries.ts?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-queries.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithQueriesWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithQueriesWorkflow.java?collapse_prequel"} 
@Workflow
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithQueriesWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go queries.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/queries.go?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/queries.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_queries.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_queries.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_queries.py" />
...
```ts signup-with-signals.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-signals.ts?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-signals.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithSignalsWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithSignalsWorkflow.java?collapse_prequel"} 
@Workflow
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithSignalsWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go signals.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/signals.go?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/signals.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_signals.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_signals.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_signals.py" />
...
```ts signup-with-events.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-events.ts?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-events.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithEventsWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithEventsWorkflow.java?collapse_prequel"} 
@Workflow
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithEventsWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go events.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/events.go?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/events.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_events.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_events.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_events.py" />
...
```ts signup-with-timers.ts expandable {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-timers.ts?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-timers.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithTimersWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithTimersWorkflow.java?collapse_prequel"} 
@Workflow
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithTimersWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go timers.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/timers.go?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/timers.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_timers.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_timers.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_timers.py" />
...
```ts signup-with-retries.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-retries.ts#retries"} 
try {
  const retryPolicy = {
    maxRetryAttempts: 3,
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-retries.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithRetriesWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithRetriesWorkflow.java#retries"} 
try {
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithRetriesWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go retries.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/retries.go#retries"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/retries.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_retries.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_retries.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_retries.py" />
...
```ts signup-with-sagas.ts {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-sagas.ts?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/typescript/tutorials/tour-of-workflows-typescript/src/workflows/signup-with-sagas.ts" />

</GlobalTab>
<GlobalTab title="Java">

```java SignupWithSagasWorkflow.java {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithSagasWorkflow.java?collapse_prequel"} 
@Workflow
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/java/tutorials/tour-of-workflows-java/src/main/java/my/example/workflows/SignupWithSagasWorkflow.java" />

</GlobalTab>
<GlobalTab title="Go">

```go sagas.go {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/go/tutorials/tour-of-workflows-go/examples/sagas.go?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/go/tutorials/tour-of-workflows-go/examples/sagas.go" />

</GlobalTab>
<GlobalTab title="Python">

```python signup_with_sagas.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_sagas.py?collapse_prequel"} 
...
<GitHubLink url="https://github.com/restatedev/examples/tree/new_tours/python/tutorials/tour-of-workflows-python/app/workflows/signup_with_sagas.py" />

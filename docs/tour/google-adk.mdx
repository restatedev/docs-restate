...
```python advanced/rollback_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/examples/app/rollback_agent.py?collapse_imports"} 

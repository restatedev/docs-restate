...
sidebarTitle: "Google ADK - Python"
...
```python durable_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/durable_agent.py?collapse_imports"} 
@function_tool
...
```python utils/utils.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/utils/utils.py#weather"} 
...
```python human_approval_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/human_approval_agent.py#here"} 
@function_tool
...
```python human_approval_agent_with_timeout.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/human_approval_agent_with_timeout.py#here"} 
...
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/sub_workflow_agent.py#wf"} 
...
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/sub_workflow_agent.py#here"} 
@function_tool
async def human_approval(claim: InsuranceClaim) -> str:
...
```python chat.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/chat.py?collapse_imports"} 
...
```python multi_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/multi_agent.py?collapse_imports"} 
intake_agent = Agent(
    name="IntakeAgent",
...
```python multi_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/multi_agent_remote.py#here"} 
...
<Warning>
    When using the OpenAI Agent SDK with Restate, tool calls are forced to be executed sequentially to ensure deterministic execution during replays.
...
```python parallel_tools_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/parallel_tools_agent.py#here"} 
@function_tool
...
```python parallel_agents.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/parallel_agents.py#here"} 
@agent_service.handler()
...
```python error_handling.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/error_handling.py#handle"} 
try:
    result = await DurableRunner.run(
        agent,
        req.message,
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/main/openai-agents/tour-of-agents/tour-of-agents/app/errorhandling.py" />
...
#### Raising terminal errors
In case you want to fail the agent execution on terminal errors, you can configure the OpenAI Agent SDK to raise terminal errors instead of converting them into LLM messages.

To raise terminal errors, set your tool's `failure_error_function`:

```python error_handling.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/mcp_openai/openai-agents/tour-of-agents/app/error_handling.py#here"} 
...
If you use Restate Context actions in your tool execution, Restate will retry any transient errors in these actions until they succeed.

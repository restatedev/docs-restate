...
import Observability from '/snippets/tour/ai/observability.mdx';
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/tree/google_adk_tour/google-adk/tour-of-agents" />
...
Or via `curl`:
```bash
curl localhost:8080/WeatherAgent/user123/run \
  --json '{"message": "What is the weather like in San Francisco?", "session_id": "session-123"}'
```
...
```python durable_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/durable_agent.py?collapse_imports"} 
APP_NAME = "agents"
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/durable_agent.py" />
...
2. **Restate Session Service**: Use the `RestateSessionService` in the Google ADK Runner. This service persists the agent's session state in Restate, allowing it to recover from failures and maintain context across invocations. We will cover session management in more detail later.
...
```bash
curl localhost:8080/WeatherAgent/user123/run \
--json '{"message": "What is the weather like in Denver?", "session_id": "session-234"}'
```
...
```python utils/utils.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/utils/utils.py#weather"} 
...
```python human_approval_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/human_approval_agent.py#here"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/human_approval_agent.py" />
...
<Accordion title="Try out human approval" icon={"laptop"}>
    ...
    ```bash
    curl localhost:8080/HumanClaimApprovalAgent/user123/run/send \
...
```python human_approval_agent_with_timeout.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/human_approval_agent_with_timeout.py#here"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/human_approval_agent_with_timeout.py" />

Try it out by sending a request to the service:
```bash
curl localhost:8080/HumanClaimApprovalWithTimeoutsAgent/user123/run/send \
--json '{"message": "Process my hospital bill of 3000USD for a broken leg.", "session_id": "session-123"}'
```
...
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/sub_workflow_agent.py#wf"} 
...
async def review(ctx: restate.Context, claim: InsuranceClaim) -> str:
    ...
    return await approval_promise
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/sub_workflow_agent.py" />

This can now be called from the main agent via a service client:
```python sub_workflow_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/sub_workflow_agent.py#here"} 
async def human_approval(claim: InsuranceClaim) -> str:
    """Ask for human approval for high-value claims."""
    return await restate_object_context().service_call(review, claim)
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/sub_workflow_agent.py" />
...
<Accordion title="Try out sub-workflows" icon={"laptop"}>
    ...
    ```bash
    curl localhost:8080/SubWorkflowClaimApprovalAgent/user123/run/send \
    --json '{"message": "Process my hospital bill of 3000USD for a broken leg.", "session_id": "session-123"}'
    ```
...
```python chat.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/chat.py?collapse_imports"} 
APP_NAME = "agents"
...
async def message(ctx: restate.ObjectContext, req: ChatMessage) -> str | None:
    ...
    return final_response
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/chat.py" />
...
```python multi_agent.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/multi_agent.py?collapse_imports"} 
APP_NAME = "agents"
...
async def run(ctx: restate.ObjectContext, claim: InsuranceClaim) -> str | None:
    ...
    return final_response
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/multi_agent.py" />
...
```python multi_agent_remote.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/multi_agent_remote.py#here"} 
...
async def run(ctx: restate.ObjectContext, claim: InsuranceClaim) -> str | None:
    ...
    return final_response
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/multi_agent_remote.py" />
...
```python parallel_tools.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/parallel_tools.py#here"} 
...
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/parallel_tools.py" />
...
```python parallel_agents.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/parallel_agents.py#here"} 
@agent_service.handler()
async def run(ctx: restate.ObjectContext, claim: InsuranceClaim) -> str | None:
    ...
    return final_response
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/parallel_agents.py" />
...
```python error_handling.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/error_handling.py#retries"}
app = App(name=APP_NAME, root_agent=agent, plugins=[RestatePlugin(max_model_call_retries=3)])
```
<GitHubLink url="https://github.com/restatedev/ai-examples/blob/google_adk_tour/google-adk/tour-of-agents/app/error_handling.py" />
...
```python error_handling.py {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/google_adk_tour/google-adk/tour-of-agents/app/error_handling.py#handle"}
```
...
Have a look at the [saga guide](/guides/saga) to learn more.

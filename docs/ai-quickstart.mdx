...
The agent you just invoked uses Durable Execution to make agents resilient to failures.

Have a look at the Invocations tab in the Restate UI to see the steps Restate persisted:
<Frame>

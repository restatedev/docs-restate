...
```ts expandable {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/vercel-ai/template/src/app.ts"} 
...
```python expandable {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/openai-agents/template/agent.py"} 
import restate
...
```python expandable {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/google-adk/template/agent.py"} 
import restate
...
```ts expandable {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/typescript-restate-only/template/src/agent.ts"} 
import * as restate from "@restatedev/restate-sdk";
import { tool } from "ai";
...
```shell
restate example python-restate-agent && cd python-restate-agent
```
...
```python expandable {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/ai-examples/refs/heads/ai-structure/python-restate-only/template/agent.py"} 
import json
import restate
from pydantic import BaseModel

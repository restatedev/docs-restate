...
description: "Invoke services from non-Restate Go services."
---
...
handle2, err := restateingress.AttachInvocation[*MyOutput](
  restateClient, invocationId).
  Attach(context.Background())

// ---------------------------------
// OPTION 3: With the idempotency key
handle3, err := restateingress.AttachService[*MyOutput](

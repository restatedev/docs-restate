...
<AccordionGroup>
  <Accordion title="Timeout settings">
    ...
    <p>
      <strong>When to adjust:</strong> For long-running operations like LLM calls, long-running tasks, or external API calls that take longer than the default timeout.
    </p>
  ...
  <Accordion title="Retention policies">
    ...
    <p><strong>Default:</strong> 24 hours</p>
  ...
  <Accordion title="Error handling">
    ...
    <p>
      <strong>Example:</strong> Map validation failures to terminal errors.
    </p>
    
    <p>
      See the <a href="/develop/ts/error-handling#mapping-errors-to-terminalerror">error handling docs</a> for detailed examples.
    </p>
  </Accordion>
</AccordionGroup>

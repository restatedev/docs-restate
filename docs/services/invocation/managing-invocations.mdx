...
You can configure a global default retry policy for all invocations in your cluster as follows, for example via the [`restate-server` configuration file](/server/configuration):

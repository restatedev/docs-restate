...
Via the UI:
<Frame>
<img src="/img/services/invocation/cancel.png" alt="Restart from prefix" width="100%" />
</Frame>
...
<Accordion title="How Cancellation Works">
    ...
    <CodeGroup>
```typescript TypeScript {"CODE_LOAD::ts/src/services/cancellation-example.ts#here"} 
...
```
```go Go {"CODE_LOAD::go/services/cancellation-example.go#here"} 
...
```
```java Java {"CODE_LOAD::java/src/main/java/services/CancellationExample.java#here"} 
@Handler
...
```
```python Python {"CODE_LOAD::python/src/services/cancellation_example.py#here"} 
...
Via the UI:
<Frame>
<img src="/img/services/invocation/kill.png" alt="Restart from prefix" width="100%" />
</Frame>
...
Via the UI:
<Frame>
<img src="/img/services/invocation/resume.png" alt="Restart from prefix" width="100%" />
</Frame>
...
Via the UI:
<Frame>
<img src="/img/services/invocation/restart-as-new.png" alt="Restart from prefix" width="100%" />
</Frame>
...
<img src="/img/services/invocation/restart-from-prefix.png" alt="Restart from prefix" width="70%" />

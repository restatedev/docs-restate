...
<Accordion title="How Cancellation Works">
    ...
    <CodeGroup>
    ```typescript code/ts/src/cancellation-example.ts
    ```
    ```go code/go/cancellation-example.go
    ```
    ```java code/java/src/main/java/cancellation/CancellationExample.java
    ```
    ```python code/python/cancellation_example.py
    ```
    </CodeGroup>

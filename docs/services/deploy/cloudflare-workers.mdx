...
Make sure your `wrangler.toml` sets the `nodejs_compat` flag, disables minification, and enables preview urls:
    ...
    steps:
      ...
      - name: Build & Deploy Worker
        ...
        with:
          ...
          command: |
            deploy
            versions upload --message "Deployed via GitHub Actions - commit ${{ github.sha }}"

...
icon: "/img/cloud-providers/deno.svg"
---
...
import DenoCicdWorkflow from '/snippets/common/deno-cicd-workflow.mdx';
...
<Step title={"Deploy your project to Deno Deploy"}>

After configuring request identity validation, create and deploy the application from [the Deno Deploy console](https://console.deno.com/) by connecting your GitHub repository.

You can also create and deploy the application from the project directory with the Deno CLI:

...
<CodeGroup>
```typescript TypeScript {"CODE_LOAD::ts/src/develop/tunnel-operator.ts#operator_in_process_tunnel"} 
...
```go Go {"CODE_LOAD::go/develop/tunnel_operator.go#operator_in_process_tunnel"} 
import (
  "context"
  "log/slog"
  "os"

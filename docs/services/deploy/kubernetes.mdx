...
The CRD is an extension of a native `Deployment` object, but automatically manages registration and [versioning](/services/deploy/kubernetes#automatic-service-versioning) for you.
...
<Info>
    ...
    Or check out the [Restate Cloud documentation](/cloud/connecting-services) for more information.
</Info>
...
You would then [register the service](/services/versioning#registering-a-deployment) at `http://<service>.<namespace>:9080`.

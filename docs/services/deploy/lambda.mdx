...
<Step title="Package and deploy your function">
...
<Tabs>
    ...
    <Tab title="Python">
        ...
        Set the Lambda handler to `handler.app`.
...
When using Restate Cloud, create an IAM role that allows Restate Cloud to invoke your Lambda function. This invoker role is separate from the execution role used by the function itself.

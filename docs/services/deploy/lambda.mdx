...
This guide covers Lambda handler setup, packaging, and service registration.
...
<Tabs>
    <Tab title="TypeScript">
        ...
        See the [TypeScript serving docs](/develop/ts/serving#creating-a-lambda-handler) for more info.
    </Tab>
    <Tab title="Python">
        <Card
        ...
        The `restate.app` function creates a valid AWS handler, so you just need to bind that.
    </Tab>
    <Tab title="Java">
...
When using Cloud, you'll need to create a Role in IAM for Restate Cloud to invoke your Lambda.

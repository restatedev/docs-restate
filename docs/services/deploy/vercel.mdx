...
Vercel deployments are public HTTP endpoints. Configure request identity validation so that your service only accepts requests from the Restate environment you trust.

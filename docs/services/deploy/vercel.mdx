...
To register the service, use the [Commit URL](https://vercel.com/docs/deployments/generated-urls#generated-from-git) to make sure Restate can address specific Vercel deployments:

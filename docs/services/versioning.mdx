...
A deployment is a specific instance of your service code associated with an HTTP endpoint, a Lambda function, or other supported environment.
...
To record non-deterministic operation results for replay, see the **durable steps** documentation: [TypeScript](/develop/ts/durable-steps), [Python](/develop/python/durable-steps), [Java/Kotlin](/develop/java/durable-steps), [Go](/develop/go/durable-steps).
...
See the sections below for deployment best practices and how to [fix in-flight invocations](#common-operations).

...
The [Restate Kubernetes operator](/services/deploy/kubernetes) provides a higher-level abstraction for managing service deployments and their versions automatically.

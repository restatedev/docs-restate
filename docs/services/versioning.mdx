...
The [Restate Kubernetes operator](/server/deploy/kubernetes#restate-kubernetes-operator) provides a higher-level abstraction for managing service deployments and their versions automatically.

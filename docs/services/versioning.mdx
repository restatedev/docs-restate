...
### Advanced: Fixing a bug by updating deployed code
...
### Advanced: Pause invocations and resume on a new deployment
...
<Warning>
    This is an advanced technique. In most cases, use [pause and resume](#advanced-pause-invocations-and-resume-on-a-new-deployment) instead.
</Warning>

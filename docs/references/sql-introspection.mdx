...
|-------------|------|-------------|
| `partition_key` | `UInt64` | Internal column that is used for partitioning the services invocations. Can be ignored. |
| `id` | `Utf8` | [Invocation ID](/services/invocation/http#invocation-identifier). |
...
| `invocation_id` | `Utf8` | [Invocation ID](/services/invocation/http#invocation-identifier). |
...
| `invoked_by_id` | `Utf8` | The caller [Invocation ID](/services/invocation/http#invocation-identifier) if `invoked_by = 'service'`. |

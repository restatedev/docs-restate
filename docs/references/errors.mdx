...
See the [versioning documentation](https://docs.restate.dev/services/configuration) for more information.
...
For a complete list of configuration options, and a sample configuration, check https://docs.restate.dev/server/configuration
...
* For new invocations, register a new deployment with a new endpoint as described here: https://docs.restate.dev/services/configuration#deploying-new-service-versions.
...
For more info about service versioning, check out https://docs.restate.dev/services/configuration.

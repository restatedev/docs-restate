...
<ResponseField name="admin" type="object" post={['toml: [admin]']}>
...
will create a socket file under the data directory.
        ...
        <ResponseField name="query-engine" type="object" post={['toml: [admin.query-engine]']}>
            Storage query engine options: 

            
            <Expandable title="Properties">
                <ResponseField name="memory-size" type="string" post={['minLength: 1','toml: admin.query-engine.memory-size','env: RESTATE_ADMIN__QUERY_ENGINE__MEMORY_SIZE']} default="1.0 GiB">
                ...
                <ResponseField name="rate-limiting" type="object | null" post={['toml: [admin.query-engine.rate-limiting]']}>
...
<ResponseField name="bifrost" type="object" post={['toml: [bifrost]']}>
    Bifrost options: 
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="default-provider"  post={['toml: bifrost.default-provider','env: RESTATE_BIFROST__DEFAULT_PROVIDER']} default="replicated">
...
of replicas, or for other reasons.
        ...
        <ResponseField name="read-retry-policy"  post={['toml: [bifrost.read-retry-policy]']}>
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
        ...
        <ResponseField name="record-cache-memory-size" type="string" post={['minLength: 1','toml: bifrost.record-cache-memory-size','env: RESTATE_BIFROST__RECORD_CACHE_MEMORY_SIZE']} default="250.0 MiB">
...
Defaults: 250MB
        ...
        <ResponseField name="replicated-loglet" type="object" post={['toml: [bifrost.replicated-loglet]']}>
            Configuration of replicated loglet provider

            
            <Expandable title="Properties">
                <ResponseField name="log-server-retry-policy" type="oneOf | null" post={['toml: bifrost.replicated-loglet.log-server-retry-policy','env: RESTATE_BIFROST__REPLICATED_LOGLET__LOG_SERVER_RETRY_POLICY']}>
...
Note that this will be increased to fit the biggest batch of records being enqueued.
                ...
                <ResponseField name="read-batch-size" type="string" post={['minLength: 1','toml: bifrost.replicated-loglet.read-batch-size','env: RESTATE_BIFROST__REPLICATED_LOGLET__READ_BATCH_SIZE']} default="32.0 KiB">
...
Value must be between 0 and 1. It will be clamped at `1.0`.
                ...
                <ResponseField name="rpc-timeout" type="string" post={['toml: bifrost.replicated-loglet.rpc-timeout','env: RESTATE_BIFROST__REPLICATED_LOGLET__RPC_TIMEOUT']} default="250ms..1m">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
                ...
                <ResponseField name="sequencer-retry-policy" type="oneOf | null" post={['toml: bifrost.replicated-loglet.sequencer-retry-policy','env: RESTATE_BIFROST__REPLICATED_LOGLET__SEQUENCER_RETRY_POLICY']}>
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="store-timeout" type="string" post={['toml: bifrost.replicated-loglet.store-timeout','env: RESTATE_BIFROST__REPLICATED_LOGLET__STORE_TIMEOUT']} default="2s..1m">
...
<ResponseField name="default-retry-policy" type="object" post={['toml: [default-retry-policy]']}>
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="on-max-attempts"  post={['toml: default-retry-policy.on-max-attempts','env: RESTATE_DEFAULT_RETRY_POLICY__ON_MAX_ATTEMPTS']} default="pause">
...
<ResponseField name="ingress" type="object" post={['toml: [ingress]']}>
    Ingress options: 
...
Since v1.7.0
        ...
        <ResponseField name="ingestion" type="object" post={['toml: [ingress.ingestion]']}>
            Ingestion Options: Settings for the ingestion client
Currently only used by the Kafka ingress and the admin API.

            
            <Expandable title="Properties">
                <ResponseField name="connection-retry-policy"  required post={['toml: [ingress.ingestion.connection-retry-policy]']}>
                    Retry policy: Definition of a retry policy
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="inflight-memory-budget" type="string" required post={['minLength: 1','toml: ingress.ingestion.inflight-memory-budget','env: RESTATE_INGRESS__INGESTION__INFLIGHT_MEMORY_BUDGET']}>
                    Non-zero human-readable bytes

                </ResponseField>

                <ResponseField name="request-batch-size" type="string" required post={['minLength: 1','toml: ingress.ingestion.request-batch-size','env: RESTATE_INGRESS__INGESTION__REQUEST_BATCH_SIZE']}>
                    Non-zero human-readable bytes
...
<ResponseField name="log-format"  post={['toml: log-format','env: RESTATE_LOG_FORMAT']} default="pretty">
...
<ResponseField name="log-server" type="object" post={['toml: [log-server]']}>
...
Since v1.7.0
        ...
        <ResponseField name="rocksdb-max-file-size" type="string" post={['minLength: 1','toml: log-server.rocksdb-max-file-size','env: RESTATE_LOG_SERVER__ROCKSDB_MAX_FILE_SIZE']} default="128.0 MiB">
            Non-zero human-readable bytes
...
Since v1.7.0
        ...
        <ResponseField name="rocksdb-writable-file-max-buffer-size" type="string" post={['minLength: 1','toml: log-server.rocksdb-writable-file-max-buffer-size','env: RESTATE_LOG_SERVER__ROCKSDB_WRITABLE_FILE_MAX_BUFFER_SIZE']} default="1.0 MiB">
            Non-zero human-readable bytes
...
<ResponseField name="metadata-client" type="object" post={['toml: [metadata-client]']}>
...
<Expandable title="Option 1: Store metadata on the replicated metadata store that runs on nodes with the metadata-server role.">
        <ResponseField name="addresses" type="array" post={['toml: metadata-client.addresses','env: RESTATE_METADATA_CLIENT__ADDRESSES']}>
        ...
        <ResponseField name="type" type="string" post={['toml: metadata-client.type','env: RESTATE_METADATA_CLIENT__TYPE']}>
        </ResponseField>

        <ResponseField name="backoff-policy"  post={['toml: [metadata-client.backoff-policy]']}>
            Retry policy: Definition of a retry policy
...
The addresses are formatted as `host:port`">
        <ResponseField name="addresses" type="string" post={['toml: metadata-client.addresses','env: RESTATE_METADATA_CLIENT__ADDRESSES']}>
...
set this to any string, such as `us-east-1`.
        ...
        <ResponseField name="object-store-retry-policy"  post={['toml: [metadata-client.object-store-retry-policy]']}>
            Retry policy: Definition of a retry policy
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
        ...
        <ResponseField name="path" type="string" post={['toml: metadata-client.path','env: RESTATE_METADATA_CLIENT__PATH']}>
...
<ResponseField name="metadata-server" type="object" post={['toml: [metadata-server]']}>
...
<ResponseField name="network-error-retry-policy"  post={['toml: [network-error-retry-policy]']}>
    Retry policy: Definition of a retry policy
...
<ResponseField name="networking" type="object" post={['toml: [networking]']}>
...
similar keys are present in other config sections, such as in Service Client options.
    ...
    <Expandable title="Properties">
        <ResponseField name="connect-retry-policy"  post={['toml: [networking.connect-retry-policy]']}>
            Retry policy: Definition of a retry policy
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="data-stream-window-size" type="string" post={['minLength: 1','toml: networking.data-stream-window-size','env: RESTATE_NETWORKING__DATA_STREAM_WINDOW_SIZE']} default="2.0 MiB">
            Non-zero human-readable bytes
        ...
        <ResponseField name="fabric-memory-limit" type="string" post={['minLength: 1','toml: networking.fabric-memory-limit','env: RESTATE_NETWORKING__FABRIC_MEMORY_LIMIT']}>
            Non-zero human-readable bytes
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="message-size-limit" type="string" post={['minLength: 1','toml: networking.message-size-limit','env: RESTATE_NETWORKING__MESSAGE_SIZE_LIMIT']}>
            Non-zero human-readable bytes
...
<ResponseField name="rocksdb-max-write-rate-per-second" type="string" post={['minLength: 1','toml: rocksdb-max-write-rate-per-second','env: RESTATE_ROCKSDB_MAX_WRITE_RATE_PER_SECOND']} default="7.0 GiB">
    Non-zero human-readable bytes

</ResponseField>

<ResponseField name="rocksdb-perf-level"  post={['toml: rocksdb-perf-level','env: RESTATE_ROCKSDB_PERF_LEVEL']} default="enable-count">
...
<ResponseField name="rocksdb-total-memory-size" type="string" post={['minLength: 1','toml: rocksdb-total-memory-size','env: RESTATE_ROCKSDB_TOTAL_MEMORY_SIZE']} default="2.0 GiB">
    Non-zero human-readable bytes
...
<ResponseField name="worker" type="object" post={['toml: [worker]']}>
    Worker options: 
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="data-service-memory-limit" type="string" post={['minLength: 1','toml: worker.data-service-memory-limit','env: RESTATE_WORKER__DATA_SERVICE_MEMORY_LIMIT']} default="256.0 MiB">
            Non-zero human-readable bytes
...
DurabilityPoint = SnapshotDurablePoint
        ...
        <ResponseField name="invoker" type="object" post={['toml: [worker.invoker]']}>
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="action-throttling" type="object | null" post={['toml: [worker.invoker.action-throttling]']} default="null">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="http2-initial-connection-window-size" type="string" post={['minLength: 1','toml: worker.invoker.http2-initial-connection-window-size','env: RESTATE_WORKER__INVOKER__HTTP2_INITIAL_CONNECTION_WINDOW_SIZE']} default="5.0 MiB">
                    Non-zero human-readable bytes
...
recommended value from HTTP2 specs
                ...
                <ResponseField name="http2-initial-stream-window-size" type="string" post={['minLength: 1','toml: worker.invoker.http2-initial-stream-window-size','env: RESTATE_WORKER__INVOKER__HTTP2_INITIAL_STREAM_WINDOW_SIZE']} default="2.0 MiB">
                    Non-zero human-readable bytes
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
                ...
                <ResponseField name="http2-max-frame-size" type="string" post={['minLength: 1','toml: worker.invoker.http2-max-frame-size','env: RESTATE_WORKER__INVOKER__HTTP2_MAX_FRAME_SIZE']} default="16.0 KiB">
                    Non-zero human-readable bytes
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="invocation-throttling" type="object | null" post={['toml: [worker.invoker.invocation-throttling]']} default="null">
...
Since v1.7.3
                ...
                <ResponseField name="memory-limit" type="string" post={['minLength: 1','toml: worker.invoker.memory-limit','env: RESTATE_WORKER__INVOKER__MEMORY_LIMIT']} default="1.5 GiB">
                    Non-zero human-readable bytes
...
over the cluster internal network.
                ...
                <ResponseField name="message-size-warning" type="string" post={['minLength: 1','toml: worker.invoker.message-size-warning','env: RESTATE_WORKER__INVOKER__MESSAGE_SIZE_WARNING']} default="10.0 MiB">
                    Non-zero human-readable bytes
...
Can be overridden by the `NO_PROXY` environment variable, which supports comma separated values.
                ...
                <ResponseField name="per-invocation-initial-memory" type="string" post={['minLength: 1','toml: worker.invoker.per-invocation-initial-memory','env: RESTATE_WORKER__INVOKER__PER_INVOCATION_INITIAL_MEMORY']} default="32.0 KiB">
                    Non-zero human-readable bytes
...
If empty, the system temporary directory will be used instead.
        ...
        <ResponseField name="max-command-batch-bytes" type="string" post={['minLength: 1','toml: worker.max-command-batch-bytes','env: RESTATE_WORKER__MAX_COMMAND_BATCH_BYTES']} default="1.0 MiB">
            Non-zero human-readable bytes
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="shuffle" type="object" post={['toml: [worker.shuffle]']}>
...
manage record ingestion across partitions (shuffle).
            ...
            <Expandable title="Properties">
                <ResponseField name="connection-retry-policy"  required post={['toml: [worker.shuffle.connection-retry-policy]']}>
                    Retry policy: Definition of a retry policy
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="inflight-memory-budget" type="string" required post={['minLength: 1','toml: worker.shuffle.inflight-memory-budget','env: RESTATE_WORKER__SHUFFLE__INFLIGHT_MEMORY_BUDGET']}>
                    Non-zero human-readable bytes

                </ResponseField>

                <ResponseField name="request-batch-size" type="string" required post={['minLength: 1','toml: worker.shuffle.request-batch-size','env: RESTATE_WORKER__SHUFFLE__REQUEST_BATCH_SIZE']}>
                    Non-zero human-readable bytes
        ...
        <ResponseField name="snapshots" type="object" post={['toml: [worker.snapshots]']}>
...
Since v1.7.0
                ...
                <ResponseField name="object-store-retry-policy"  post={['toml: [worker.snapshots.object-store-retry-policy]']}>
                    Retry policy: Definition of a retry policy
...
Default: `None` - automatic snapshots are disabled
        ...
        <ResponseField name="storage" type="object" post={['toml: [worker.storage]']}>
            Storage options: 
...
Default: 64MB
                ...
                <ResponseField name="rocksdb-max-file-size" type="string" post={['minLength: 1','toml: worker.storage.rocksdb-max-file-size','env: RESTATE_WORKER__STORAGE__ROCKSDB_MAX_FILE_SIZE']} default="64.0 MiB">
                    Non-zero human-readable bytes
...
reduce scalability to more threads, especially for writes.
                ...
                <ResponseField name="rocksdb-writable-file-max-buffer-size" type="string" post={['minLength: 1','toml: worker.storage.rocksdb-writable-file-max-buffer-size','env: RESTATE_WORKER__STORAGE__ROCKSDB_WRITABLE_FILE_MAX_BUFFER_SIZE']} default="1.0 MiB">
                    Non-zero human-readable bytes

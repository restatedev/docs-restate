...
Set `type = "none"` to select this variant.

        </ResponseField>

    </Expandable>
    
    <Expandable title="type = &quot;fixed-delay&quot;">
...
Set `type = "fixed-delay"` to select this variant.

        </ResponseField>

    </Expandable>
    
    <Expandable title="type = &quot;exponential&quot;">
...
Set `type = "exponential"` to select this variant.
...
<Expandable title="type = &quot;replicated&quot;">
...
Set `type = "replicated"` to select this variant.
...
Set `type = "etcd"` to select this variant.
...
<Expandable title="type = &quot;object-store&quot;">
...
Set `type = "object-store"` to select this variant.

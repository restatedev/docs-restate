...
will create a socket file under the data directory.
        ...
        <ResponseField name="query-engine" type="object" post={[]}>
            ...
            <Expandable title="Properties">
                <ResponseField name="memory-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_ADMIN__QUERY_ENGINE__MEMORY_SIZE']} default="1.0 GiB">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
        ...
        <ResponseField name="record-cache-memory-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_BIFROST__RECORD_CACHE_MEMORY_SIZE']} default="250.0 MiB">
...
Note that this will be increased to fit the biggest batch of records being enqueued.
                ...
                <ResponseField name="read-batch-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_BIFROST__REPLICATED_LOGLET__READ_BATCH_SIZE']} default="32.0 KiB">
...
Value must be between 0 and 1. It will be clamped at `1.0`.
                ...
                <ResponseField name="rpc-timeout" type="string" post={['pattern: ^\\d+(\\.\\d+)?\\s*(ns|us|ms|s|m|h|d|nanoseconds?|microseconds?|milliseconds?|seconds?|minutes?|hours?|days?)\\s*\\.\\.\\s*\\d+(\\.\\d+)?\\s*(ns|us|ms|s|m|h|d|nanoseconds?|microseconds?|milliseconds?|seconds?|minutes?|hours?|days?)$','env: RESTATE_BIFROST__REPLICATED_LOGLET__RPC_TIMEOUT']} default="250ms..1m">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="store-timeout" type="string" post={['pattern: ^\\d+(\\.\\d+)?\\s*(ns|us|ms|s|m|h|d|nanoseconds?|microseconds?|milliseconds?|seconds?|minutes?|hours?|days?)\\s*\\.\\.\\s*\\d+(\\.\\d+)?\\s*(ns|us|ms|s|m|h|d|nanoseconds?|microseconds?|milliseconds?|seconds?|minutes?|hours?|days?)$','env: RESTATE_BIFROST__REPLICATED_LOGLET__STORE_TIMEOUT']} default="2s..1m">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="inflight-memory-budget" type="string" required post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_INGRESS__INGESTION__INFLIGHT_MEMORY_BUDGET']}>
...
Defaults to 1 MiB.
                ...
                <ResponseField name="request-batch-size" type="string" required post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_INGRESS__INGESTION__REQUEST_BATCH_SIZE']}>
...
Since v1.7.0
        ...
        <ResponseField name="rocksdb-max-file-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_LOG_SERVER__ROCKSDB_MAX_FILE_SIZE']} default="128.0 MiB">
...
Since v1.7.0
        ...
        <ResponseField name="rocksdb-writable-file-max-buffer-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_LOG_SERVER__ROCKSDB_WRITABLE_FILE_MAX_BUFFER_SIZE']} default="1.0 MiB">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="data-stream-window-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_NETWORKING__DATA_STREAM_WINDOW_SIZE']} default="2.0 MiB">
...
Maximum theoretical value is 2^31-1 (2 GiB - 1), but we will sanitize this value to 500 MiB.
        ...
        <ResponseField name="fabric-memory-limit" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_NETWORKING__FABRIC_MEMORY_LIMIT']}>
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="message-size-limit" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_NETWORKING__MESSAGE_SIZE_LIMIT']}>
...
<ResponseField name="rocksdb-max-write-rate-per-second" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_ROCKSDB_MAX_WRITE_RATE_PER_SECOND']} default="7.0 GiB">
...
<ResponseField name="rocksdb-total-memory-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_ROCKSDB_TOTAL_MEMORY_SIZE']} default="2.0 GiB">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
        ...
        <ResponseField name="data-service-memory-limit" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__DATA_SERVICE_MEMORY_LIMIT']} default="256.0 MiB">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="http2-initial-connection-window-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__INVOKER__HTTP2_INITIAL_CONNECTION_WINDOW_SIZE']} default="5.0 MiB">
...
recommended value from HTTP2 specs
                ...
                <ResponseField name="http2-initial-stream-window-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__INVOKER__HTTP2_INITIAL_STREAM_WINDOW_SIZE']} default="2.0 MiB">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D"
                ...
                <ResponseField name="http2-max-frame-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__INVOKER__HTTP2_MAX_FRAME_SIZE']} default="16.0 KiB">
...
Since v1.7.3
                ...
                <ResponseField name="memory-limit" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__INVOKER__MEMORY_LIMIT']} default="1.5 GiB">
...
over the cluster internal network.
                ...
                <ResponseField name="message-size-warning" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__INVOKER__MESSAGE_SIZE_WARNING']} default="10.0 MiB">
...
Can be overridden by the `NO_PROXY` environment variable, which supports comma separated values.
                ...
                <ResponseField name="per-invocation-initial-memory" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__INVOKER__PER_INVOCATION_INITIAL_MEMORY']} default="32.0 KiB">
...
If empty, the system temporary directory will be used instead.
        ...
        <ResponseField name="max-command-batch-bytes" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__MAX_COMMAND_BATCH_BYTES']} default="1.0 MiB">
...
"10 hours" or "5 days" or "5d" or "1h 4m" or "P40D" or "0"
                ...
                <ResponseField name="inflight-memory-budget" type="string" required post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__SHUFFLE__INFLIGHT_MEMORY_BUDGET']}>
                    Inflight Memory Budget: Maximum total size of in-flight ingestion requests in bytes.
Tune this to your workload so there are enough unpersisted
requests for efficient batching without exhausting memory.
...
Defaults to 1 MiB.
                ...
                <ResponseField name="request-batch-size" type="string" required post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__SHUFFLE__REQUEST_BATCH_SIZE']}>
                    Request Batch Size: Maximum size of a single ingestion request batch.
Tune to keep enough requests per batch for
throughput; overly large batches can increase tail latency.
...
Default: 64MB
                ...
                <ResponseField name="rocksdb-max-file-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__STORAGE__ROCKSDB_MAX_FILE_SIZE']} default="64.0 MiB">
                    Target size for SST files: The target size for sst files. Restate uses this value to internally determine
the number of memtables to keep in memory and how much to merge before flushing.
...
reduce scalability to more threads, especially for writes.
                ...
                <ResponseField name="rocksdb-writable-file-max-buffer-size" type="string" post={['pattern: ^\\d+(\\.\\d+)? ?[KMG]B$','minLength: 1','env: RESTATE_WORKER__STORAGE__ROCKSDB_WRITABLE_FILE_MAX_BUFFER_SIZE']} default="1.0 MiB">
                    Buffer size used for writing to SST files: Sets the maximum buffer size that is used to write SST files to disk.
Larger values translate to larger IO operations which can be helpful
for slow or network-attached storage devices.

...
<ResponseField name="rocksdb-total-memory-size" type="string" post={['default="2.0 GiB"','format: non-zero human-bytes','minimum: 1','minLength: 1']}>
    Non-zero human-readable bytes

</ResponseField>

<ResponseField name="rocksdb-total-memtables-ratio" type="number" post={['default=0.85','format: float']}>

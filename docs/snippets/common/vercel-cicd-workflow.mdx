```yml .github/workflows/deploy.yml {"CODE_LOAD::https://raw.githubusercontent.com/restatedev/vercel-template/refs/heads/main/.github/workflows/deploy.yml?remove_comments"}

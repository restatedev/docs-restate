...
```yml expandable .github/workflows/deploy.yml {"CODE_LOAD::workflows/lambda-typescript.yml?remove_comments"}
...
<Tab title="Python">
```yml expandable .github/workflows/deploy.yml {"CODE_LOAD::workflows/lambda-python.yml?remove_comments"}
name: Deploy to AWS Lambda

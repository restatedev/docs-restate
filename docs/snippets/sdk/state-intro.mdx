...
Access Rules:
- [Exclusive handlers](/basics/functions#handler-behavior) (e.g., `run()` in workflows) can read and write state.
- [Shared handlers](/basics/functions#handler-behavior) can only read state and cannot mutate it.

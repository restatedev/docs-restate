...
2. **User/system cancellations**: When you [cancel](/operate/invocation#cancelling-invocations) long-running invocations, sagas undo previous operations to maintain consistency.

---
title: "Single-node Restate on Kubernetes with Restate Operator"
...
<Frame>
<img src={"/img/guides/restate-operator-on-kind/registered-service.png"}/>
</Frame>
...
<Frame>
    <img src={"/img/guides/restate-operator-on-kind/invoke.png"}/>
</Frame>

...
- [Encore CLI installed](https://encore.dev/docs/ts/install)
- An Encore app (`encore app create`)
:::
...
- [Durable execution use cases](/use-cases/durable-execution)

...
```ts order-processor/restate.ts {"CODE_LOAD::ts/src/guides/encore/restate.ts"}
...
```ts order-processor/encore.restate.ts {"CODE_LOAD::ts/src/guides/encore/encore.restate.ts"}
import { Service } from "encore.dev/service";
export default new Service("order-processor");
```

```ts order-processor/api.ts {"CODE_LOAD::ts/src/guides/encore/api.ts"}
...
```ts order-processor/orders.ts {"CODE_LOAD::ts/src/guides/encore/orders.ts"}
import { api } from "encore.dev/api";

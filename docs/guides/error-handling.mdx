...
You can set the global retry policy in the [Restate Server configuration](/server/configuration).
...
Have a look at the [service configuration docs](/services/configuration).

#### Globally for the Restate Server

You can set the inactivity timeout via the UI, the CLI or the [Restate Server configuration](/server/configuration).

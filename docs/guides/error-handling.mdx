...
<Accordion title={"Configure server defaults"}>
...
You can cancel invocations via the [CLI](/services/invocation/http#cancelling-invocations), UI and programmatically.

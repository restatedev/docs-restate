...
<Info>
    The first stage has shipped: scope-based **concurrency limits** are now available as an opt-in feature. See the [flow control](/services/flow-control) docs to try them. The capabilities below are the planned follow-ups.
</Info>

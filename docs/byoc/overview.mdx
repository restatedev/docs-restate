...
<CardGroup cols={2}>
  <Card title="Kubernetes" href="/services/deploy/kubernetes">
    Deploy with the Restate Operator and connect through a secure tunnel.
  </Card>
  <Card title="AWS Lambda" href="/services/deploy/lambda">
    Let your BYOC environment invoke versioned Lambda functions through an IAM role.
  </Card>
  <Card title="Serverless platforms" href="/services/deploy/vercel">
    Connect public services on Vercel, Cloudflare Workers, Deno Deploy, or Google Cloud Run.
  </Card>
  <Card title="Containers and VMs" href="/services/deploy/containers-and-vms">
    Connect services on your own infrastructure through public endpoints or a secure tunnel.
  </Card>
</CardGroup>
